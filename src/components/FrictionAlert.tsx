...
export default function FrictionAlert({
  ...
  return (
    <div className="bg-[#FFF8E1] border border-[#FFE082] border-l-4 border-l-[#FFB300] rounded-2xl p-5 flex flex-col md:flex-row items-start gap-4 shadow-md">
      <div className="bg-[#FFB300]/15 p-2.5 rounded-xl border border-[#FFB300]/25 text-[#E8A403] font-bold shrink-0">
        <ShieldAlert className="w-5 h-5" />
      </div>
      <div className="space-y-2 flex-1">
        <h4 className="text-xs font-bold text-[#E8A403] uppercase tracking-wider font-display">
          IBKR Transaction Drag Alert: Excessive Overhead Detected
        </h4>
