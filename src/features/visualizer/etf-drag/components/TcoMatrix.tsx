        ...
        <table className="w-full text-left text-xs text-[#727579] border-collapse min-w-[600px]">
          <thead>
            <tr className="border-b border-[#E6E6E6] text-[#212121] font-semibold bg-[#F7F8FA] font-display">
              <th className="py-3 px-3 sticky left-0 z-10 bg-[#F7F8FA]">Evaluation Parameter</th>
          ...
          <tbody className="divide-y divide-[#E8E8E9] font-mono">
            <tr className="border-b border-[#E8E8E9] hover:bg-[#F7F8FA] transition-colors">
              <td className="py-2.5 px-3 sticky left-0 z-10 bg-white font-sans text-[#44474D]">Total Ringgit Contributed</td>
            ...
            <tr className="border-b border-[#E8E8E9] hover:bg-[#F7F8FA] transition-colors">
              <td className="py-2.5 px-3 sticky left-0 z-10 bg-white font-sans text-[#44474D]">Terminal Portfolio Valuation</td>
            ...
            <tr className="border-b border-[#E8E8E9] hover:bg-[#F7F8FA] transition-colors bg-[#F7F8FA]/50">
              <td className="py-2.5 px-3 sticky left-0 z-10 bg-white font-sans text-[#44474D] font-medium">Accumulated Dividend WHT Paid</td>
            ...
            <tr className="border-b border-[#E8E8E9] hover:bg-[#F7F8FA] transition-colors">
              <td className="py-2.5 px-3 sticky left-0 z-10 bg-white font-sans text-[#44474D]">Total Expense Ratio Fees (TER)</td>
            ...
            <tr className="border-b border-[#E8E8E9] hover:bg-[#F7F8FA] transition-colors bg-[#F7F8FA]/50">
              <td className="py-2.5 px-3 sticky left-0 z-10 bg-white font-sans text-[#44474D]">ETF Bid-Ask Spread Cost</td>
            ...
            <tr className="border-b border-[#E8E8E9] hover:bg-[#F7F8FA] transition-colors">
              <td className="py-2.5 px-3 sticky left-0 z-10 bg-white font-sans text-[#44474D]">Total Brokerage Buy & FX Commissions</td>
            ...
            <tr className="border-b border-[#D91222]/20 hover:bg-[#F7F8FA] transition-colors bg-[#D91222]/5 font-semibold text-[#212121]">
              <td className="py-2.5 px-3 sticky left-0 z-10 bg-white font-sans text-[#212121]">Total Structural Cash Drag Loss</td>
            ...
            <tr className="hover:bg-[#F7F8FA] transition-colors">
              <td className="py-2.5 px-3 sticky left-0 z-10 bg-white font-sans text-[#44474D]">Net Compounded IRR (Annualized)</td>
